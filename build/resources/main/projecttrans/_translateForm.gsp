...
<div class="modal-body">
    <blockquote class="hero">
        <p><em> <g:message code="setting.translation.popup.info" /></em></p>
    </blockquote>

    <form id="translateForm"  class="sky-form" style="border: none;" >
        ...
        <div class="row">
            <section class="col col-6">
                <label class="label"><g:message code="setting.translation.popup.key.language" /></label>
            ...
            <section class="col col-6">
                <label class="label"><g:message code="setting.translation.popup.target" /></label>
                <label class="select state-success">
                    ...
                    <i></i>
                    %{--<input name="name" class="form-control" disabled id="name" readonly type="text">--}%
                </label>
            </section>
        </div>
        <div class="row">
            ...
            <section class="col col-6">
                ...
                <label class="input">
                    ...
                    <input name="transvalue"  id="transvalue" value="${transval}" type="text" >
                </label>
            </section>
            <section>

...
<div class="tag-box tag-box-v1 margin-bottom-10">
    ...
    <div class="panel-body">
        <div >
            ...
            <a data-toggle="modal" href="/settings/helpdesk/addNewTag/${forum.id}" data-target="#myModal"  class="btn-u btn-brd rounded btn-u-default btn-u-xs" ><i class="fa fa-plus"></i> <g:message code="default.button.add.label" />  </a>
        ...
        <table class="table table-striped">
            ...
            <g:each in="${tags}" var="tag">
                <tr id="tag${tag.id}" >
                    ...
                    <td>
                        <div class="btn-group">
                            <a data-toggle="modal" href="/settings/helpdesk/edittag/${forum.id}/?tagid=${tag.id}" data-target="#myModal"  id="${tag.id}" class="btn btn-info "><i class="fa fa-pencil"></i> <g:message code="default.button.edit.label"/></a>
                            %{--<a class="btn btn-primary"  ><i class="fa  fa-globe"></i></a>--}%
                            <a class="btn btn-danger" data-toggle="modal" href="/settings/helpdesk/deltag/${tag.id}" data-target="#myModal"  ><i class="fa fa-trash-o"></i></a>
                        </div>
                    </td>
                </tr>
            </g:each>

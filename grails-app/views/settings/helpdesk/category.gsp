                ...
                <tr id="category${category.id}" >
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a data-toggle="modal" href="/settings/helpdesk/editCategory/${forum.id}/?catid=${category.id}" data-target="#ucmodal"  id="${category.id}" class="btn btn-info "><i class="fa fa-pencil"></i> <g:message code="default.button.edit.label"/></a>
                            ...
                            <a class="btn btn-danger" data-toggle="modal" href="/settings/helpdesk/delcategory/${category.id}" data-target="#ucmodal"  ><i class="fa fa-trash-o"></i></a>
                        </div>
                    </td>
                </tr>
            </g:each>

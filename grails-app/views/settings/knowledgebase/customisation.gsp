...
<div class="tag-box tag-box-v1 margin-bottom-10">
    ...
    <ol class="breadcrumb hidden-xs">
        ...
        <li class="active"><g:link controller="knowledgebase" action="customisation" > <g:message code="setting.leftMenu.community.customisation" /></g:link></li>
    </ol>

    <div id="customisation">
        <div class="tab-v1 margin-bottom-60">
            <ul class="nav nav-tabs">
                <li class="<g:if test="${params.vtype==null || params.vtype=='dashboard'}"> active</g:if>"><g:link controller="knowledgebase" action="customisation" id="${params.id}" params="${[vtype: 'dashboard']}" ><g:message code="module.display.type.0" /></g:link></li>
                <li class="<g:if test="${params.vtype=='list'}"> active</g:if>"><g:link controller="knowledgebase" action="customisation" id="${params.id}" params="${[vtype: 'list']}" ><g:message code="module.display.type.1" /></g:link></li>
                <li class="<g:if test="${params.vtype=='widget'}"> active</g:if>"><g:link controller="knowledgebase" action="customisation" id="${params.id}" params="${[vtype: 'widget']}" ><g:message code="module.display.type.2" /></g:link></li>

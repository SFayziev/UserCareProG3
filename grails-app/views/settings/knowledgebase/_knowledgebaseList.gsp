    ...
    <div class="panel panel-sea margin-bottom-40">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td> ${forum.name}</td>
                <td> </td>
                <td><g:link controller="knowledgebase" action="setting" id="${forum.id}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> <g:message code="default.button.edit.label"/></g:link>
                    </td>
            </tr>
            </g:each>
            </tbody>

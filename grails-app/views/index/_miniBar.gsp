        ...
        <g:if test="${module?.dispos==ModulePosType.Mini}">
            ...
            <g:if test="${customize}">
                <div class="action_buttons">
                    ...
                    <g:if test="${!module?.moduleTypeDTO?.undeletable==true}"><button class="btn btn-primary btn-sm" data-action="widgetDELETE" data-content="${module?.id}" type="button"><i class="fa fa-trash "></i></button></g:if>

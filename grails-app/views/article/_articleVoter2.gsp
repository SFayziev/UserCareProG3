<div  id="votepanel-${article?.id}" class="comment-action-bar">
    <span class="vote-text"><g:message code="article.vote2.title"/></span><br>
    ...
    <button class="btn btn-warning" id="votedown-${article?.id}" data-content="${article?.id}" data-action="votearticle" data-vote-value="-1"><i class="expand-list rounded-x fa fa-thumbs-down"></i> <g:message code="article.vote2.value.down"/></button>

...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="#"  onclick="setArticleListType(${module?.id},  -1) ; return false;"><i class="fa fa-arrows-alt"></i> All  <span class="badge badge-blue rounded-x">${pageCount?.getCountByType(-1 )}</span></a></li>
        <li class="divider"></li>
    %{--<li><a href="#"  onclick="setArticleListType(-1)"><i class="fa fa-arrows-alt"></i> All  <span class="badge badge-blue rounded-x">${pageCount?.getCountByType(-1 )}</span></a></li>--}%
        <g:each in="${forumTypes}" var="topicTypeDTO">
            <li> <a  href="#" data-action="listByType" data-type-value="${topicTypeDTO?.id}" onclick="setArticleListType(${module?.id}, ${topicTypeDTO?.id}); return false;" >
                %{--<g:render template="/file/imageByType" model="${[imgid: "forumtype${topicTypeDTO.id}", imgclass: "img-responsive avatar rounded-x", iconclass: 'icon-sm', img:topicTypeDTO?.articleTypeDTO?.imgDTO]}" />--}%
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="#"  data-action="listByStatus" onclick="setArticleListStatus(${module?.id}, -1) ; return false;"> All <span class="badge  badge-blue rounded-x">${pageCount?.getCountByStatus(-1 )}</span></a></li>
        <li class="divider"></li>
        <li><a href="#"   data-action="listByStatus" data-status-value="0" onclick="setArticleListStatus(${module?.id}, 0 ) ; return false;">  Unmarked <span class="badge badge-blue rounded-x">${pageCount?.getUnmarkedTopic()}</span></a></li>
        <li><a href="#"   data-action="listByStatus" data-status-value="-10" onclick="setArticleListStatus(${module?.id}, -10 ) ; return false;">  Active <span class="badge badge-blue rounded-x">${pageCount?.getActiveTopic()}</span></a></li>
...
<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu" role="menu">
        <li onclick="setArticleListOrder(${module?.id},'byupdatedate') ; return false;"><a href="#" ><i class="fa fa-edit"></i> <g:message code="order.type.byupdatedate" /></a></li>
        <li onclick="setArticleListOrder(${module?.id},'bycreatedate') ; return false;"><a href="#" ><i class="fa fa-cloud"></i> <g:message code="order.type.bycreatedate" /></a></li>
        <li onclick="setArticleListOrder(${module?.id},'bycomment') ; return false;"><a href="#"  ><i class="fa fa-cloud"></i> <g:message code="order.type.bycomment" /></a></li>
    <g:if test="${forum?.type?.compareTo(ForumType.Community)==0}">
        <li class="divider"></li>
        <li onclick="setArticleListOrder(${module?.id},'top') ; return false;"><a href="#" ><i class="fa fa-eye"></i> <g:message code="order.type.top" /></a></li>
        <li onclick="setArticleListOrder(${module?.id},'byupvotes') ; return false; "><a href="#" ><i class="fa fa-eye"></i> <g:message code="order.type.byupvotes" /></a></li>
        <li onclick="setArticleListOrder(${module?.id},'bydownvotes') ; return false;"><a href="#" ><i class="fa fa-edit"></i> <g:message code="order.type.bydownvotes" /></a></li>
        <li onclick="setArticleListOrder(${module?.id},'byviews') ; return false;"><a href="#" ><i class="fa fa-cloud"></i> <g:message code="order.type.byviews" /></a></li>
        <li onclick="setArticleListOrder(${module?.id},'byfollow') ; return false;"><a href="#" ><i class="fa fa-cloud"></i> <g:message code="order.type.byfollow" /></a></li>
    </g:if>
    </ul>
</div>
</g:if>
    ...
    <div class="testimonials-info">
        ...
        <div class="overflow-textH">
            <div  class="topic-votes pull-right">
                <span data-content="${article?.id}" data-action="voteshow"  id="votesum-${article?.id}" class="margin-left-5 rounded label <g:if test="${article?.voteSum<0 }">label-warning</g:if><g:else>label-success</g:else>" >

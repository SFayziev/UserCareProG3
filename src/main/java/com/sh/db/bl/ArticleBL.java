...
import com.sh.db.map.topics.ArtilceFilterDTO;
...
public class ArticleBL {
    ...
    public List<ArtilceFilterDTO> getArticleFilterByProjId(Integer projId) {
        UserDTO userDTO = permissionBL.getCurrentLoggedUser();
        return userDTO== null? articleDAO.getArticleFilterByProjId(projId, 0) : articleDAO.getArticleFilterByProjId(projId, userDTO.getId());
    }
}